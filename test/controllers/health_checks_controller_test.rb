...
class HealthChecksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create health_check" do
    ...
    assert_redirected_to pet_health_check_url(@pet, HealthCheck.last, locale: I18n.default_locale)
  end
  ...
  test "should update health_check" do
    ...
    assert_redirected_to pet_health_check_url(@pet, locale: I18n.default_locale)
  end
