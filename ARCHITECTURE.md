...
1. Finish the **S4** operator steps (GitHub Support purge, run the forced password reset, back up the new signing key). Every other security finding (S1–S3, S5–S14) is fixed.
