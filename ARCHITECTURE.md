...
1. Finish the last **S4** operator step: back up the new signing key and `keystore.properties` off the machine. The GitHub Support purge (verified 2026-09-22) and the forced password reset for the 3 exposed accounts (2026-09-22) are done. Every other security finding (S1–S3, S5–S14) is fixed.
